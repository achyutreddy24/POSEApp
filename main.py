...
def form_post():
    ...
    #return render_template("result.html", reddit = reddit_sent, reddit_low = reddit_extremes["min"], reddit_high = reddit_extremes["max"], final_text = final_text, text = text)
